...
const Welcome = () => {
    ...
    return (
        ...
        <header id='1' className="min-h-screen flex flex-col justify-center items-center relative">
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-none items-start p-3 sm:p-8 md:p-10 lg:p-14 xl:p-28 w-full max-w-screen-2xl px-3 mb-16">
          ...
          <div className="scroll-down-arrow absolute bottom-8 left-1/2 transform -translate-x-1/2">
            <a href="#works">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-8 w-8 text-white bg-transparent/10 hover:bg-transparent/100 bg-neutral-800 shadow-lg rounded-full p-2 -mt-24">
