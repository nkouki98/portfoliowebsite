 ...
 <div id="" className="bg-black mx-5 rounded-xl shadow-xl p-16 w-screen mt-2">
      ...
      <div className="flex flex-col md:flex-row mx-auto my-10">
        ...
        <div className="w-full md:w-1/2 md:pl-8">
          ...
          <p className="mt-4 text-lg text-left text-gray-300 px-2 mb-2 font-thin tracking-tight ">An interactive weather app that shows useful weather details and nearby restaurants for the user with dynamic background imagery that adapts to any city the user searches.</p>
          <p className='text-left text-zinc-400 px-2 mb-5 tracking-tight font-thin font-mono'>React, Tailwind CSS, Rapid API</p>
      ...
      <div className="flex flex-col md:flex-row mx-auto my-10">
        ...
        <div className="w-full md:w-1/2 md:pl-8">
          ...
          <p className="mt-4 text-lg text-left text-gray-300 font-sans font-thin mb-1">An app that leverages user reivews and NLP libary to score comments and build a confidence measure for youtube channels that review tech products.</p>
          
          <p className='text-left text-zinc-400 font-mono font-thin mb-5'>Java, Spring boot, Python text processing</p>
      ...
      <div className="flex flex-col md:flex-row mx-auto my-10">
        ...
        <div className="w-full md:w-1/2 md:pl-8">
          ...
          <p className="mt-4 text-lg text-left text-gray-300 font-thin font-sans mb-5"> A series of projects to explore in more detail the process of ideation and converting it to a practical application.</p>
          <button  onClick={(e) => {
            e.preventDefault();
